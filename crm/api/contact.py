...
def on_update(doc, method=None):
	# Runs after the Contact is written, in the same transaction, so its computed primary
	# email/mobile and full name are final before they are mirrored into linked Deals.
	from crm.fcrm.doctype.crm_deal.crm_deal import sync_deals_from_contact

	sync_deals_from_contact(doc)
