 ...
 * Contacted: a lead is contacted, then a discovery meeting is set. */
export const DISCOVERY_STATUS = 'Discovery meeting set'
 ...
 */
export function requiresDiscovery(fromStatus, toStatus) {
 ...
 */
export function requiredDiscoveryFields(data) {
...
export function validateDiscovery(data) {
  const doc = data || {}
  return requiredDiscoveryFields(doc).filter((fieldname) => !isFilled(doc[fieldname]))
}
